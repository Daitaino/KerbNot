...
public class WorldRenderer implements Disposable{
	...
	private Animation<TextureRegion> animationStar;
	private Animation<TextureRegion> animationMeteor;
	...
	public WorldRenderer (Level level, OrthographicCamera camera) {
		...
		animationMeteor = new Animation<TextureRegion>(1f/80f, textureMeteor.getRegions());
		...
		animationStar = new Animation<TextureRegion>(1f/80f, textureStar.getRegions());
